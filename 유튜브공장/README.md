...
> **이 저장소는 독립형 `유튜브공장` 구성입니다.** OpenMontage가 최상위 총괄 감독이고, MK Visual Director·HyperFrames·Remotion·로컬 ComfyUI와 수동 TopView handoff를 한 파이프라인으로 관리합니다. 처음에는 [`docs/operations/START-HERE.md`](docs/operations/START-HERE.md)를 읽으세요.
